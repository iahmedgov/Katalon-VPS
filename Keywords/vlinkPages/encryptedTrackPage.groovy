...
// Select the Generate Remittance ID button
			findTestObject('Object Repository/VLink/Page_EncryptedTrack/btn_GenerateRemID')
			
// Select the Process VLink Transaction button
						
			findTestObject('Object Repository/VLink/Page_EncryptedTrack/btn_ProcessVLinkTran')
